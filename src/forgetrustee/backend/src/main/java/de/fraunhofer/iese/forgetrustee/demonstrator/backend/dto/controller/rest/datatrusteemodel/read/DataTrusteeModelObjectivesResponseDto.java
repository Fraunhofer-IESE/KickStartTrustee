...
@NoArgsConstructor
@AllArgsConstructor
public class DataTrusteeModelObjectivesResponseDto {

  private List<CommentedValueRestDto<DataTrusteeGoal>> dataTrusteeGoals;

  private List<CommentedValueRestDto<MotivationRightsHolder>> motivationRightsHolder;

  private List<CommentedValueRestDto<MotivationDataHolder>> motivationDataHolder;

  private List<CommentedValueRestDto<MotivationDataConsumer>> motivationDataConsumer;
