...
@Data
public class ForgeIndividualStatement extends ForgeOntStatement {

  private String id;

  private String individualSubjectUri;

  private ForgeIndividual FTIndividual;

  private ForgePredicate property;
}
