...
public enum MotivationDataHolder implements LabeledConcept {
  TRUST_INTERMEDIARY("https://forgetrustee.kickstarttrustee.de/ontology/dtm-business#TrustIntermediary", "Trust Intermediary",
      "Vertrauensinstanz"),
