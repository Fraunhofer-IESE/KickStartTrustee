...
@NoArgsConstructor
@AllArgsConstructor
public class DataTrusteeModelLegalResponseDto {

  private List<CommentedProcessingBasisRestDto> processingBases;

  private CommentedValueRestDto<ConsentType> consentType;

  private String obtainingConsentBy;

  private CommentedValueRestDto<ConsentEnteredBy> consentEnteredBy;
}
